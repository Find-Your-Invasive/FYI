...
def RandomForests (array, code):
    ...
    db_connection_str = 'mysql+pymysql://root:avinator@localhost/fyi'
...
def MYSQLADD (code, lon, lat, ab):
    ...
    sql = "INSERT INTO 2var"+code+"a VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (finalres [0], finalres [1], finalres [2], finalres [3], finalres [4], finalres [5], finalres [6], finalres [7], finalres [8], finalres [9])
    sql2 = "INSERT INTO future2var"+code+"a VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", (finalres [0], finalres [1], finalres [3], finalres [5], finalres [6], finalres [7], finalres [8], finalres [9])
...
#Questions
stringer=input ("Type 1 for current, type 2 for 2021-2040, type 3 for 2041-2060, type 4 for 2061-2080, type 5 for 2081-2100:, type 6 for AddYourInvasive (existing), type 7 for CreateYourInvasive : ")
codeval=input ("Type in invasive code (See Documentation): ")

if stringer!="6" and stringer!="7":
